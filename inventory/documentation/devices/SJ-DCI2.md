...
| --------- | --------------- | ------------ | --------- |
| SJ_DCI1_2 | Vlan4094 | 10.255.252.12 | Port-Channel3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SJ-SPINE1_Ethernet6 | routed | - | 198.18.200.25/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SJ-SPINE2_Ethernet6 | routed | - | 198.18.200.27/31 | default | 1500 | false | - | - |
...
| 198.18.10.8 | 65103 | default | - | Inherited from peer group DCI-OVERLAY-PEERS | Inherited from peer group DCI-OVERLAY-PEERS | - | Inherited from peer group DCI-OVERLAY-PEERS | - |
...
router bgp 65003
   ...
   neighbor 10.255.250.5 local-as 65002 no-prepend replace-as
   neighbor 10.255.250.5 description AS-DCI2
   neighbor 10.255.251.12 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.12 description SJ-DCI1
   ...
   neighbor 198.18.10.8 remote-as 65103
   ...
   neighbor 198.18.200.24 description SJ-SPINE1_Ethernet6
   neighbor 198.18.200.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 198.18.200.26 remote-as 65000
   neighbor 198.18.200.26 description SJ-SPINE2_Ethernet6
