...
| --------- | --------------- | ------------ | --------- |
| AS_DCI1_2 | Vlan4094 | 10.255.252.13 | Port-Channel3 |
...
| 198.18.0.7 | 65003 | default | - | Inherited from peer group DCI-OVERLAY-PEERS | Inherited from peer group DCI-OVERLAY-PEERS | - | Inherited from peer group DCI-OVERLAY-PEERS | - |
