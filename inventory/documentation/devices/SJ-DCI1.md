...
| --------- | --------------- | ------------ | --------- |
| SJ_DCI1_2 | Vlan4094 | 10.255.252.13 | Port-Channel3 |
...
| 198.18.10.7 | 65103 | default | - | Inherited from peer group DCI-OVERLAY-PEERS | Inherited from peer group DCI-OVERLAY-PEERS | - | Inherited from peer group DCI-OVERLAY-PEERS | - |
...
router bgp 65003
   ...
   neighbor 10.255.250.3 local-as 65002 no-prepend replace-as
   neighbor 10.255.250.3 description AS-DCI1
   neighbor 10.255.251.13 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.13 description SJ-DCI2
   ...
   neighbor 198.18.10.7 remote-as 65103
